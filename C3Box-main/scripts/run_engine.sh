...
python main.py --config=./configs/engine/engine_cifar_B0_Inc10.json
...
python main.py --config=./configs/engine/engine_inr_B0_Inc20.json
python main.py --config=./configs/engine/engine_inr_B100_Inc20.json
python main.py --config=./configs/engine/engine_cub_B0_Inc20.json
