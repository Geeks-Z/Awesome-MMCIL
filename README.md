...
3. `hyper-parameters`
   ...
   - **model_name**: Select one of the implemented methods: `finetune`, `zs_clip`, `foster`, `memo`, `simplecil`, `l2p`, `dualprompt`, `coda`, `aper`, `tuna`, `rapf`, `CLG-CBM`, `mg_clip`, `proof`, `engine` or `bofa`.
