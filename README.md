...
- ### Dataset split
  ...
  - 只呈现Avg_Acc指标，其他指标见日志
  - Avg_Acc 按照 `OpenAI_CLIP / OpenCLIP_LAION400M / OpenCLIP_LAION2b` 统计
...
> Avg_Acc: `OpenAI_CLIP / OpenCLIP_LAION400M / OpenCLIP_LAION2b`

**seed = 1993**

|           | B0 Inc5     | B0 Inc10     | B0 Inc20    | B50 Inc5    | B50 Inc10   |
| --------- | ------------ | ----------- | ------------ | ------------ | ------------ |
| ENGINE | / 87.16 / | / 86.85 / | / 86.09 / | / 82.97 / | / 83.17 / |
| PROOF | / 87.34 / | / 86.84 / | / 86.05 / | / 82.93 / | / 83.3 / |
...
| ------------ | --------- | -------- | --------- | ---------- | ---------- |
| ENGINE       | / 86.17 / | / 86.22/ | / 85.92 / | / 83.14 /  | / 83.68 /  |
| PROOF        | / 83.57 / | / 83.6 / | / 82.89 / | / 81.04 /  | / 81.36 /  |
...
|              | B0 Inc10  | B0 Inc20  | B0 Inc40 | B100 Inc10 | B100 Inc20 |
| ------------ | --------- | --------- | -------- | ---------- | ---------- |
| ENGINE       | 83.66//   | 83.68//   | 83.11//  |            |            |
| PROOF        |           |           |          |            |            |
| RAPF         | 86.09 / / | 85.91 / / | 85.09//  | 82.1//     | 82.67 / /  |
| MoE-Adapters | 85.99/ /  | 86.5/ /   | 86.57/ / | 84.96/ /   | 84.42/ /   |
...
|              | B0 Inc5  | B0 Inc10 | B0 Inc20 | B100 Inc10 | B100 Inc20 |
| ------------ | -------- | -------- | -------- | ---------- | ---------- |
| ENGINE       | /86.82/  | /86.64/  | /85.96/  | /82.08/    | /83.09/    |
| PROOF        | /85.34/  | /84.66/  | /83.32/  | /81.32/    | /81.32/    |
| RAPF         | 74.11/ / | 78.5/ /  | 81.4/ /  | 64.58/ /   | 71.19/ /   |
| MoE-Adapters | 65.6/ /  | 65.67/ / | 66.06/ / | 62.25/ /   | 63.5/ /    |
