...
class OLF(nn.Module):
    ...
    def __init__(self, in_features, out_features, W0_torch, rank=64):
        ...
        self.register_buffer('A', torch.zeros(self.in_features, self.rank))
        self.W_task.requires_grad = False  # 初始时冻结
        self.register_buffer('W_fusion', W0_torch.clone().detach())
        self.register_buffer('W_fusion2', W0_torch.clone().detach())
        self.cov_matrices = []
